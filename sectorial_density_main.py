...
probs = sectorial_multi_beta_paral(g,repetitions=6,default_delay=4,
                                   beta_lapse=0.033,num_sectors= 5,
                                   filename='ER/results/sectorial_prova',
                                   max_iterations=100)
end = time.time()
print(end - start)

betas = np.arange(0, 1, 0.033)
