...
name_or = 'ER/results/density_ratio3_SOFT'
for delay in [2, 3, 4, 5]:
    name = name_or + str(delay) + '.pickle'
    name2 = 'ER/images/density_ratio3_SOFT' + str(delay) + '.png'
    densities = density_with_sigma(g, beta=0.6, delay=delay, repetitions=100, filename=name)
